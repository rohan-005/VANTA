  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-40 w-full transition-all duration-300 ${
        isScrolled
          ? 'bg-vanta-ivory/90 backdrop-blur-md border-b border-vanta-sand py-3 shadow-md'
          : 'bg-gradient-to-b from-vanta-ivory/90 to-transparent py-5'
      }`}
    >
      <div className="w-full gutter-padding flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-3 group focus:outline-none focus-visible:ring-2 focus-visible:ring-vanta-lime rounded-sm"
        ...
        >
          ...
          <div className="flex flex-col text-left">
            <span className="font-display font-extrabold text-2xl tracking-wider text-vanta-dark group-hover:text-vanta-lime transition-colors">
              VANTA
            </span>
            <span className="font-mono text-[9px] uppercase tracking-widest text-vanta-text-muted-dark -mt-1 flex items-center gap-1">
        ...
        <nav className="hidden md:flex items-center gap-8" aria-label="Desktop Navigation">
          <button
            ...
            className="text-xs font-mono font-semibold uppercase tracking-widest text-vanta-text-muted-dark hover:text-vanta-dark transition-colors flex items-center gap-1.5 focus:outline-none focus-visible:text-vanta-lime"
          >
        ...
        <button
          ...
          className="md:hidden p-2.5 text-vanta-dark hover:text-vanta-lime focus:outline-none focus-visible:ring-2 focus-visible:ring-vanta-lime rounded-sm border border-vanta-sand bg-vanta-cream"
      ...
      {isMobileOpen && (
        <div className="md:hidden w-full bg-vanta-cream/98 border-b border-vanta-sand backdrop-blur-xl px-5 py-6 shadow-2xl transition-all">
          <div className="flex flex-col gap-4">
            ...
            <button
              onClick={() => handleNavClick('showcase')}
              className="flex items-center justify-between p-3.5 rounded-sm bg-vanta-ivory border border-vanta-sand text-vanta-dark hover:border-vanta-dark text-left"
            >
