...
export const HeroGraphics: React.FC = () => {
  ...
  return (
    <div className="relative w-full max-w-xl mx-auto lg:max-w-none flex flex-col items-center select-none">
      ...
      <div className="absolute -top-10 right-0 z-20 flex items-center gap-2 bg-vanta-cream border border-vanta-sand p-1.5 rounded-sm shadow-sm backdrop-blur-md">
        <button
          onClick={() => setThermalMode(!thermalMode)}
          className={`px-3 py-1.5 text-[11px] font-mono uppercase tracking-wider flex items-center gap-1.5 transition-colors rounded-sm ${
            thermalMode
      ...
      <div className="relative w-full aspect-[4/3] bg-gradient-to-b from-vanta-charcoal to-vanta-dark border border-vanta-charcoal rounded-sm p-6 shadow-card-sharp flex items-center justify-center overflow-hidden group">
        {/* Background Subtle Line Grid */}
        <div className="absolute inset-0 bg-line-grid-dark opacity-30" />

        {/* Ambient Backlight Glow (Acid Lime & Burnt Orange - NO BLUE) */}
        <div
          className={`absolute inset-0 bg-radial from-vanta-lime/15 via-transparent to-transparent transition-opacity duration-700 ${
            activeLed ? 'opacity-100' : 'opacity-10'
          }`}
        />

        {/* Precision SVG Vector Graphics of VANTA Chassis Monolith */}
        <svg
          viewBox="0 0 500 400"
        ...
        >
          <defs>
            ...
            <linearGradient id="chassisGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#2A2B27" />
            ...
            <linearGradient id="glassGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <stop offset="100%" stopColor="rgba(17, 18, 17, 0.7)" />
            </linearGradient>
            ...
            {/* Thermal Airflow Vectors (Emerald Intake & Burnt Orange Exhaust - ZERO BLUE) */}
          ...
          <path d="M250 122 L264 122 M257 115 L257 129" stroke={activeLed ? "#B8E600" : "#9A9990"} strokeWidth="1.5" />
          ...
          <line x1="215" y1="205" x2="215" y2="245" stroke="#3A3C37" strokeWidth="2" />
          <line x1="225" y1="205" x2="225" y2="245" stroke="#3A3C37" strokeWidth="2" />
          ...
          <text x="160" y="320" fill="#9A9990" fontSize="10" fontFamily="JetBrains Mono">
            CHASSIS_01 // ISOLATED_PSU_BAY
          </text>
          <circle cx="375" cy="315" r="4" fill={activeLed ? "#B8E600" : "#6E6D66"} />

          {/* Thermal Overlay Elements when thermalMode is active (EMERALD INTAKE & ORANGE EXHAUST) */}
          {thermalMode && (
            <g className="transition-opacity duration-300">
              {/* Cold Air Intake Vectors (Emerald Green) */}
              ...
              {/* Hot Air Exhaust Vectors (Burnt Orange) */}
              ...
              <text x="45" y="365" fill="#00FF99" fontSize="9" fontFamily="JetBrains Mono" fontWeight="bold">
                [ EMERALD: COLD INTAKE VECTOR 185 CFM ]
              </text>
              <text x="250" y="18" fill="#E86F2D" fontSize="9" fontFamily="JetBrains Mono" fontWeight="bold">
                [ ORANGE: TOP EXHAUST VECTOR ]
              </text>
            </g>
          )}
        </svg>

        {/* Bottom Hardware Spec Overlay Bar */}
        <div className="absolute bottom-3 left-4 right-4 flex items-center justify-between px-3 py-1.5 bg-vanta-dark/90 border border-vanta-border rounded-sm backdrop-blur-md text-[11px] font-mono text-vanta-text-muted-light">
          <div className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-vanta-lime" />
            <span className="text-vanta-ivory font-medium">CHASSIS 01 // BILLET ALUMINUM</span>
          </div>
