...
export const Engineering: React.FC = () => {
  return (
    <section
      id="engineering"
      className="relative w-full py-20 lg:py-32 bg-vanta-stone border-b border-vanta-sand overflow-hidden text-vanta-dark"
    >
      ...
      <div className="w-full gutter-padding relative z-10 space-y-16">
        ...
        <div className="flex flex-col items-start space-y-4">
          ...
          <p className="text-base text-vanta-text-muted-dark font-sans max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 bg-vanta-cream border border-vanta-sand hover:border-vanta-dark rounded-sm transition-colors space-y-4 flex flex-col justify-between shadow-sm">
            <div className="space-y-3">
              ...
              <p className="font-sans text-xs text-vanta-text-muted-dark leading-relaxed">
            ...
            <div className="pt-4 border-t border-vanta-sand flex items-center justify-between font-mono text-[11px] text-vanta-text-muted-dark">
          ...
          <div className="p-6 bg-vanta-cream border border-vanta-sand hover:border-vanta-dark rounded-sm transition-colors space-y-4 flex flex-col justify-between shadow-sm">
            ...
            <div className="pt-4 border-t border-vanta-sand flex items-center justify-between font-mono text-[11px] text-vanta-text-muted-dark">
              ...
              <span className="text-vanta-dark font-bold">WHISPER QUIET</span>
            </div>
          </div>
